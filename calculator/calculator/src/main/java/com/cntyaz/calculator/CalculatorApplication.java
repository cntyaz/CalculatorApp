	...
	private Consumer<ItemEvent> themeSwitchEventConsumer = event -> {
		...
		switch (selectedTheme) {
			...
			case "Colored":
				...
				btnRoot.setBackground(Color.MAGENTA);
				btnLog.setBackground(Color.MAGENTA);
				btnPower.setBackground(Color.MAGENTA);
				...
				break;
			case "DarkTheme":
				final Color primaryDarkColor = new Color(141, 45, 99);
				final Color secondaryDarkColor = new Color(171, 171, 173);

				window.getContentPane().setBackground(new Color(110, 112, 123));
